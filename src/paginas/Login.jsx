...
const Login = () => {
    ...
    return(
        <>
            <div>
                <h1 className="text-indigo-700 font-black text-6xl">Inicia Sesion y Administra tus {""}<span className="text-black">Pacientes</span></h1>
            </div>
            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                <nav className='nt-10 lg:flex lg:justify-between'>
